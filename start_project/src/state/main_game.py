...
def main_game_update(platform, player, key, mobile_key, game_input, dt, collision_rects, camera, menu_ui, menu_ui_save, menu_ui_load, menu_ui_title, menu_ui_settings, menu_ui_inventory, menu_ui_skills, menu_ui_achievement, display):
    match platform:
        case 'pc':
            player.update(key, dt, joysticks=game_input.joysticks, collision_rects=collision_rects)
        case 'android':
